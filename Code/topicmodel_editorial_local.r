...
result_trimmed <- FindTopicsNumber(
                        dtm_test_trimmed,
                        topics = seq(from = 2, to = 10, by = 4), #I increased to 25 since there are a large number of documents; for NG < 60 I used 10
...
# "Griffiths2004",
saveRDS(result_trimmed, "../ExportFiles/topics_search_result_Editorial_Local.rds")
