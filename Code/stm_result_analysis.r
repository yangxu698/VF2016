...
stm_news_local = readRDS("/home/yang/VF2016Combined/ExportFiles/STM_News_Local_Covariate.rds")
stm_news_wire = readRDS("/home/yang/VF2016Combined/ExportFiles/STM_News_Wire_Covariate.rds")

df1_tb1_news_local = readRDS("/home/yang/VF2016Combined/News Local_df1_dfma_trimmed.rds")
df1_tb1_news_wire = readRDS("/home/yang/VF2016Combined/News Wire_df1_dfma_trimmed.rds")

model_stm = stm_news_local[[2]]
...
model_stm = stm_news_wire[[2]]
stm_df <- data.frame(t(labelTopics(model_stm, n = 25)$prob))
td_beta <- tidy(model_stm)
td_gamma <- tidy(model_stm, matrix = "gamma",
                 document_names = rownames(df1_tb1_news_wire))
...
#################################################################################
stm_2grams_news_local = readRDS("/home/yang/VF2016Combined/ExportFiles/STM_2grams_News_Local_Covariate.rds")
